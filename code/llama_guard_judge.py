"""Run Llama Guard 4 over prompt/response pairs in a JSON array.

Example:
    python llama_guard_judge.py input.json output.json
"""
...
def render_prompt(processor: Any, prompt: str, response: str) -> str:
...
def generate_raw_outputs(
    ...
    prompts = [
        render_prompt(processor, record["prompt"], record["response"])
