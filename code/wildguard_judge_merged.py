"""Run WildGuard over prompt/response pairs in a JSON array.

Example:
    python wildguard_judge_merged.py input.json output.json
"""
...
RAW_FIELD = "wildguard_raw_output"
...
def render_prompt(prompt: str, response: str) -> str:
...
def generate_raw_outputs(
    ...
    prompts = [render_prompt(record["prompt"], record["response"]) for record in records]
