"""Run XGuard over prompt/response pairs in a JSON array.

Example:
    python xguard_judge_merged.py input.json output.json
"""
...
MODEL = "Alibaba-AAIG/YuFeng-XGuard-Reason-8B"
RAW_FIELD = "xguard_raw_output"
